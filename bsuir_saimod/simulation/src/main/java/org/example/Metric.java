...
public class Metric {
    ...
    public Metric(double inputTasks, double processedTasks, double missedTasks, double leavedTasks, double downtime, double probabilityOfProcessing, double probabilityOfFailure) {
        this.inputTasks = inputTasks;
        this.processedTasks = processedTasks;
        this.missedTasks = missedTasks;
        this.leavedTasks = leavedTasks;
    ...
    public void incLeavedTasks() {
        this.leavedTasks++;
    }

    public double getLeavedTasks() {
        return leavedTasks;
    }
